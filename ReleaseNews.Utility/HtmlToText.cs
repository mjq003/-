...
namespace ReleaseNews.Utility
{
    public class HtmlToText
    {
        ...
        public string ConvertImgSrc(string html)
        {
            // 定义正则表达式用来匹配 img 标签            
            ...
            {
                imgUrl = "/images/occupying.png";
            }
            return imgUrl;
        }

        public string ConvertImgByFace(string face)
        {
            //循环
            //for (int i = 0; i < 60; i++)
            //{
            ...
            //}
            //正则
            return Regex.Replace(face, "<emt>\\d+</emt>", match => { return $"<img src=\"../images/face/{XElement.Parse(match.ToString()).Value}.gif\"></img>"; });
        }
